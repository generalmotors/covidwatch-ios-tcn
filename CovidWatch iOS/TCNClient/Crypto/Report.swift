...
public struct Report: Equatable {
    ...
    public func getTemporaryContactNumbers() -> [TCNTemporaryContactNumber] {
...
extension ReportAuthorizationKey {
    ...
    public func createSignedReport(
        ...
        return TCNSignedReport(report: report, signatureBytes: signatureBytes)
    }
    
}

/// A signed exposure report, whose source integrity can be verified to produce a `Report`.
public struct TCNSignedReport: Equatable {
