...
public struct ReportAuthorizationKey: Equatable {
    ...
    var tck_0: TemporaryContactKey {
        return TemporaryContactKey(
            ...
            bytes: SHA256.hash(data: H_TCK_DOMAIN_SEPARATOR + reportAuthorizationPrivateKey.rawRepresentation).tcnDataRepresentation
        )
    }
...
public struct TCNTemporaryContactNumber: Equatable {
...
public struct TemporaryContactKey: Equatable {
    ...
    public var temporaryContactNumber: TCNTemporaryContactNumber {
        return TCNTemporaryContactNumber(
            bytes: SHA256.hash(
                data: H_TCN_DOMAIN_SEPARATOR + index.tcnDataRepresentation + bytes
            ).tcnDataRepresentation[0..<16]
        )
    }
