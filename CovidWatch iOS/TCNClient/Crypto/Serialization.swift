    ...
    public func serializedData() throws -> Data {
        do {
            ...
            return reportVerificationPublicKeyBytes +
                ...
                startIndex.tcnDataRepresentation +
                endIndex.tcnDataRepresentation +
                memoType.tcnDataRepresentation +
                memoLength.tcnDataRepresentation +
            memoData
        }
        catch {
            throw TCNError.OversizeMemo(memoData.count)
...
extension TCNSignedReport: TCNSerializable {
...
extension TemporaryContactKey: TCNSerializable {
    ...
    public func serializedData() -> Data {
        return index.tcnDataRepresentation + reportVerificationPublicKeyBytes + bytes
    }
